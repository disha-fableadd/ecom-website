        ...
        function fetchCart() {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.length === 0) {
                        // Cart is empty, show the message and hide other sections
                        $('#cartTable').hide();
                        $('#emptyCartMessage').show();
                        $('#cartSummary').hide();  // Hide the cart summary section
                        $('#submitOrder').hide();
                        return;
                    }

                    // Cart is not empty, display cart and summary
                    $('#cartTable').show();
                    $('#emptyCartMessage').hide();
                    $('#cartSummary').show();  // Show the cart summary section
                    $('#submitOrder').show(); 
